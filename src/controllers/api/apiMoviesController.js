...
module.exports = {
    getAll: (req, res) => {
        ...
        .catch((error) => {
            if(error.name === 'SequelizeConnectionRefuseError' ) {
        ...
        .catch((error) => {
            switch (error.name) {
                case 'SequelizeValidationError' :
                    let errorsMsg = [];
                    let notNullErrors = [];
                    let validationsErros = [];
                    error.errors.forEach((error) => {
                        errorsMsg.push(error.message);
                        if(error.type == 'Validation error') {
                            validationsErros.push(error.message);
                        }
                        if (error.type == 'notNull Validation' ) {
